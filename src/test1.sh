...
#./gdal_trace_outline testcase4.png -nodataval 255 -out-cs xy -wkt-out good-tc4.wkt -split-polys
...
./gdal_trace_outline testcase4.png -nodataval 255 -out-cs xy -wkt-out test-tc4.wkt -split-polys
